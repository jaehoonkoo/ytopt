...
# ##############
python Run_online_TL.py --kernel_name syr2k --max_evals 30 --n_refit 5 --top 0.3 --nparam 6 --param_start 0 --target sm -itarget 130 160 -imin 20 30 -imax 3000 3800
mv tmp_files tmp_files_sm
mv results_sdv.csv results_sdv_sm_syr2k_refit.csv
# ##############
python Run_online_TL.py --kernel_name syr2k --max_evals 30 --n_refit 5 --top 0.3 --nparam 6 --param_start 0 --target ml -itarget 600 720 -imin 20 30 -imax 3000 3800
mv tmp_files tmp_files_ml
mv results_sdv.csv results_sdv_ml_syr2k_refit.csv
# ##############
python Run_online_TL.py --kernel_name syr2k --max_evals 30 --n_refit 5 --top 0.3 --nparam 6 --param_start 0 --target xl -itarget 2000 2600 -imin 20 30 -imax 3000 3800
mv tmp_files tmp_files_xl
mv results_sdv.csv results_sdv_xl_syr2k_refit.csv
# mkdir ./tmp_results
# rm ytopt.log
