...
cd /lcrc/project/EE-ECP/jkoo/code/sdv/Benchmarks/lu_exp/lu_l
# ##############
# mkdir ./tmp_results
# rm ytopt.log
...
mv results.csv results_rs_l_lu.csv
mv tmp_results tmp_results_rs_run1
mv tmp_files tmp_files_rs_run1
mv ytopt.log ytopt_rs_l_lu_run1.log
# ##############
rm ytopt.log
mkdir ./tmp_results
...
mv results.csv results_rf_l_lu.csv
mv tmp_results tmp_results_rf_run1
mv tmp_files tmp_files_rf_run1
mv ytopt.log ytopt_rf_l_lu_run1.log
##############
# mkdir ./tmp_results
