...
input_sizes= {}
input_sizes[(120)]  = [' -DSMALL_DATASET'] 
input_sizes[(260)] = [' -DSM_DATASET'] 
input_sizes[(400)]  = [' -DMEDIUM_DATASET'] 
input_sizes[(1200)] = [' -DML_DATASET'] 
input_sizes[(2000)]  = [' -DLARGE_DATASET'] 
input_sizes[(4000)] = [' -DEXTRALARGE_DATASET'] 
...
def main():
    ...
    ## input space 
    t0 = Integer(40, 6000, transform="normalize", name="t0")
