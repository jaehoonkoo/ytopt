...
rm ./TLA_experiments/SLA-GPTune-s-200/* 
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-s-200/lu.json 
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-s-200/results.csv
# mv save_results.npy save_results_sla_s_lu.npy
...
rm ./TLA_experiments/SLA-GPTune-m-200/* 
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-m-200/lu.json 
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-m-200/results.csv
# mv save_results.npy save_results_sla_m_lu.npy
...
rm ./TLA_experiments/SLA-GPTune-l-200/* 
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-l-200/lu.json
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-l-200/results.csv
# mv save_results.npy save_results_sla_l_lu.npy
...
rm ./TLA_experiments/SLA-GPTune-sm-200/*
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-sm-30/lu.json 
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-sm-30/results.csv
# mv save_results.npy save_results_sla_sm_lu.npy
...
rm ./TLA_experiments/SLA-GPTune-ml-200/*
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-ml-30/lu.json 
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-ml-30/results.csv
# mv save_results.npy save_results_sla_ml_lu.npy
...
rm ./TLA_experiments/SLA-GPTune-xl-200/*
mv gptune.db/lu.json ./TLA_experiments/SLA-GPTune-xl-30/lu.json 
mv gptune.db/results.csv ./TLA_experiments/SLA-GPTune-xl-30/results.csv
# mv save_results.npy save_results_sla_xl_lu.npy
