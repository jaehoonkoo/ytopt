...
#         cmd1 = "gcc  -O3 "  +interimfile +" " + kernel_dir + "/polybench.c" \
#                 + " -I" + kernel_dir + \
#                 " " + d_size + " -DPOLYBENCH_TIME -o "+tmpbinary

#         cmd1 = "clang -fno-caret-diagnostics "  +interimfile +" " + kernel_dir + "/polybench.c" \
#                 + " -I" + kernel_dir + \
#                 " " + d_size + " -DPOLYBENCH_TIME -O3 -o "+tmpbinary        
        
        cmd1 = "clang -fno-caret-diagnostics "  +interimfile +" " + kernel_dir + "/polybench.c" \
                + " -I" + kernel_dir + \
                " " + d_size + " -DPOLYBENCH_TIME -std=c99 -fno-unroll-loops -O3 -mllvm -polly-process-unprofitable -mllvm -polly-use-llvm-names -ffast-math -march=native -o "+tmpbinary
        print (cmd1)
