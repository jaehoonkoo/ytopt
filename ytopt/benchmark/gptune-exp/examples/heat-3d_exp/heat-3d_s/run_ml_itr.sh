...
#SBATCH --output=stdout_ml_sdv_run1.%j

# module load nvhpc/21.5-oxhtyof
source activate /home/jkoo/.conda/envs/ytune
cd /lcrc/project/EE-ECP/jkoo/code/sdv/Benchmarks/heat-3d_exp/heat-3d_l/
# ##############
# mkdir ./tmp_results
# rm ytopt.log
...
mv results.csv results_rs_l_heat-3d.csv
mv tmp_results tmp_results_rs_run1
mv tmp_files tmp_files_rs_run1
mv ytopt.log ytopt_rs_l_heat-3d_run1.log
# ##############
rm ytopt.log
mkdir ./tmp_results
...
mv results.csv results_rf_l_heat-3d.csv
mv tmp_results tmp_results_rf_run1
mv tmp_files tmp_files_rf_run1
mv ytopt.log ytopt_rf_l_heat-3d_run1.log
##############
# mkdir ./tmp_results
