...
def objectives(point: dict):
    ...
    x = np.array([point[f'p{i+1}'] for i in range(len(x1))])
...
def main():
    ...
    tuning_metadata = {
        "tuning_problem_name": "covariance",
        "use_crowd_repo": "no",
    ...
    ## input space 
    t0 = Integer(28, 3800, transform="normalize", name="t0")
    t1 = Integer(32, 4000, transform="normalize", name="t1")
