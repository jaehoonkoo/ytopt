...
dataframe = pd.read_csv("results_rf_l_cov.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:5]    
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rf_l_cov_rerun.csv"
fields   = ['p1','p2','p3','p4','p5','exe_time1','exe_time2','exe_time3']
# writing to csv file 
...
#                     x1[5]:sample_point_val[5],}
        ...
        ss = [sample_point['p1']] + [sample_point['p2']] + [sample_point['p3']] +[sample_point['p4']]+[sample_point['p5']]+[res1]+[res2]+[res3]
        csvwriter.writerow(ss)    

        
### RS rerun 
dataframe = pd.read_csv("results_rs_l_cov.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:5]    
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rs_l_cov_rerun.csv"
fields   = ['p1','p2','p3','p4','p5','exe_time1','exe_time2','exe_time3']
# writing to csv file 
with open(filename, 'w') as csvfile: 
    # creating a csv writer object 
