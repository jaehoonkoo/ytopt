...
spack load gptune 
cd /lcrc/project/EE-ECP/jkoo/code/gptune/examples/covariance_exp/covariance_gptune_dtla_tl
rm -rf ./tmp_results*
rm -rf ./tmp_files*
#################################
...
mpirun -n 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize sm -kernel_name covariance -nparam 5 -param_start 1 -target sm -itarget 160 180 -imin 28 32 -imax 3800 4000
mkdir ./TLA_experiments/SLA-GPTune-sm-tl/ 
mv gptune.db/covariance.json ./TLA_experiments/SLA-GPTune-sm-tl/covariance.json 
