...
def objectives(point: dict):
    ...
    if task == i_target:
        print (f"................NEW.....Task:",point[tuple(task)])
    ...
    ### old task
        ...
        print (f"................OLD.....Task:",point[tuple(task)])
        print ("point",point)
...
def create_gptune(Kernel_name, nodes, cores, n_param, param_start, param_name, i_min, i_max, task_name):
    ...
    ## tuning parameter
    Tuning_params = []
    p1 = Categoricalnorm(["#pragma clang loop(j2) pack array(data) allocate(malloc)", " "], transform="onehot", name="p1") 
...
if __name__ == "__main__":
    ...
    model_functions = {}
    for i, ss in zip(range(1,len(giventask),1),['s','m','l']):
        ...
        meta_dict = {
            ...
            "input_space":i_space,
            "parameter_space": [
        {"name": "p1","transformer": "onehot","type": "categorical","categories": ["#pragma clang loop(j2) pack array(data) allocate(malloc)", " "]},
