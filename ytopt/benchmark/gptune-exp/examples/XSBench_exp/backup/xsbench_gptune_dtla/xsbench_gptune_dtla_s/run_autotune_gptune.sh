...
mpirun -n 1 python demo_dlta_test.py -nrun 5 -ntask 4 -perfmodel 0 -optimization GPTune -dsize sm
...
mkdir -p gptune.db
mv db.out gptune.db/xsbench.json
mpirun -n 1 python demo_dlta_test.py -nrun 5 -ntask 4 -perfmodel 0 -optimization GPTune -dsize ml
...
mkdir -p gptune.db
mv db.out gptune.db/xsbench.json
mpirun -n 1 python demo_dlta_test.py -nrun 5 -ntask 4 -perfmodel 0 -optimization GPTune -dsize xl
