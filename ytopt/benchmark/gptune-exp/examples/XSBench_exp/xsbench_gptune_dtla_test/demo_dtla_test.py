...
input_s = {}
input_s[int(100000)] = 's' 
input_s[int(500000)] = 'sm' 
input_s[int(1000000)] = 'm' 
input_s[int(2500000)] = 'ml' 
input_s[int(5000000)] = 'l' 
input_s[int(10000000)] = 'xl'
...
#       results, cmd, counter = plopper_func(x) 
      results =[random.uniform(0, 1)+50, random.uniform(0, 1)+50, random.uniform(0, 1)+50]
      now = time.time()
...
def main():
    ...
    ## input space 
    t = Integer(1, 2100000000, transform="normalize", name="t")

 # tuning parameter
    p0 = Categoricalnorm(['2','4','8','16','32','48','64','96','128','192','256'], transform="onehot", name="p0")
    ...
    output_space = Space([Real(0.0, float('Inf'), name="y")])
...
#         giventask = [[round(tvalue,1)],[round(tvalue*2.0,1)]]
    ...
    for i in range(1,len(giventask),1):
        ...
        print ('======================================',tvalue_, input_s[tvalue_])
        meta_dict = {
            "tuning_problem_name":"hepnos",
            "modeler":"Model_GPy_LCM",
            "task_parameter":[[tvalue_]],
            "input_space": [{"name":"t","type":"int","transformer":"normalize","lower_bound":1,"upper_bound":2100000000}],
            "parameter_space": [
        {
          "name": "p0",
          "transformer": "onehot",
        ...
        },
        {
          ...
          "categories": [
            ...
            "output_space": [{"name":"y","type":"real","transformer":"identity","lower_bound":0.0,"upper_bound":float('Inf')}],
        ...
        f.close()
        model_functions[tvalue_] = BuildSurrogateModel(metadata_path=None,metadata=meta_dict,function_evaluations=func_evals['func_eval'])
#         metadata_path="./.gptune/xbench.json", metadata =None, function_evaluations:dict = None
