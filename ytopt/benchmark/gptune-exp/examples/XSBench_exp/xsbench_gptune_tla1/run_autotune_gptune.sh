...
spack load gptune 
### go the directory 
cd /gpfs/jlse-fs0/users/jkoo/code/gptune/examples/XSBench_exp/xsbench_gptune_tla1
rm -rf gptune.db
mpirun -n 1 python demo_tla1.py -nrun 200 -ntask 3 -perfmodel 0 -optimization GPTune -tla 1
mv gptune.db/xsbench.json ./TLA_experiments/SLA-GPTune-mla-200/
mv save_results.npy save_results_mla_tla1_xsbench.npy
