...
sys.path.insert(0, os.path.abspath(__file__ + "/../../../../GPTune/"))
# sys.path.insert(0, os.path.abspath("/home/jkoo/spack/opt/spack/linux-opensuse_leap15-zen2/gcc-11.1.0/gptune-master-3rsrfsvvxboqub5grt4wsld6o7lbgfrc/lib/python3.8/site-packages/gptune/"))
...
def objectives(point: dict):
  ...
  def plopper_func(x):
    ...
    result = obj.findRuntime(value, params, ' -s large -m event -l '+ d_size) # defined(MINI_DATASET) && !defined(SMALL_DATASET) && !defined(MEDIUM_DATASET) && !defined(LARGE_DATASET) && !defined(EXTRALARGE_DATASET) && !defined(HUGE_DATASET)
    return result
