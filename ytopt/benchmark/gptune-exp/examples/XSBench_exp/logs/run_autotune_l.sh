...
cd /gpfs/jlse-fs0/users/jkoo/code/kde/Benchmarks/XSBench_exp/xsbench_l
...
mv exe_times.npy exe_times_rf_l_xsbench.npy
...
mv results.csv results_rs_l_xsbench.csv
mv exe_times.npy exe_times_rs_l_xsbench.npy
