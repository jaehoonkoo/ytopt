...
# mv results_sdv_time.csv results_sdv_ml_xsbench_time.csv
# mv exe_times_sdv_time.npy exe_times_sdv_ml_xsbench_time.npy
cd /gpfs/jlse-fs0/users/jkoo/code/kde/SDV/Benchmarks/XSBench_exp/xsbench_ml_sdv
python learnBO_1_sdv_itr_time_n1.py
mv results_sdv_itr_time_n1.csv results_sdv_ml_xsbench_itr_time_n1.csv
mv exe_times_sdv_itr_time_n1.npy exe_times_sdv_ml_xsbench_itr_time_n1.npy
