...
def myobj(point: dict):
  ...
  def plopper_func(x):
    ...
    result = obj.findRuntime(value, params, ' -s large -m event -l 1000000') # defined(MINI_DATASET) && !defined(SMALL_DATASET) && !defined(MEDIUM_DATASET) && !defined(LARGE_DATASET) && !defined(EXTRALARGE_DATASET) && !defined(HUGE_DATASET)
    return result
