...
dataframe = pd.read_csv("results_rf_l_3mm.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:10]    
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rf_l_3mm_rerun.csv"
fields   = ['p0','p1','p2','p3','p4','p5','p6','p7','p8','p9','exe_time1','exe_time2','exe_time3']
# writing to csv file 
with open(filename, 'w') as csvfile: 
    ...
    for idx in range(N_infer):
        ...
        ss = [sample_point['p0']] +[sample_point['p1']] + [sample_point['p2']] + [sample_point['p3']] +[sample_point['p4']]+[sample_point['p5']]+[sample_point['p6']]+[sample_point['p7']]+[sample_point['p8']]+[sample_point['p9']]+[res1]+[res2]+[res3]
        csvwriter.writerow(ss)    

        
### RS rerun 
dataframe = pd.read_csv("results_rs_l_3mm.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:10]  
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rs_l_3mm_rerun.csv"
fields   = ['p0','p1','p2','p3','p4','p5','p6','p7','p8','p9','exe_time1','exe_time2','exe_time3']
# writing to csv file 
with open(filename, 'w') as csvfile: 
    # creating a csv writer object 
