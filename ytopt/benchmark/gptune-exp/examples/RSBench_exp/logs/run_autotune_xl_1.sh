...
# mv results_sdv_itr_time.csv results_sdv_xl_rsbench_itr_time.csv
# mv exe_times_sdv_itr_time.npy exe_times_sdv_xl_rsbench_itr_time.npy
# python learnBO_1_sdv_time.py
# mv results_sdv_time.csv results_sdv_xl_rsbench_time.csv
# mv exe_times_sdv_time.npy exe_times_sdv_xl_rsbench_time.npy
cd /gpfs/jlse-fs0/users/jkoo/code/kde/SDV/Benchmarks/RSBench_exp/rsbench_xl
python learnBO_1_kde_ytopt_all.v5.GS.py
mv results_kde.csv results_kde_xl_rsbench.csv
mv exe_times_kde.npy exe_times_kde_xl_rsbench.npy