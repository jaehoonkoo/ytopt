...
cd /gpfs/jlse-fs0/users/jkoo/code/kde/SDV/Benchmarks/RSBench_exp/rsbench_m
...
mv results.csv results_rf_m_rsbench.csv
mv exe_times.npy exe_times_rf_m_rsbench.npy
...
mv results.csv results_rs_m_rsbench.csv
mv exe_times.npy exe_times_rs_m_rsbench.npy
