...
def merge_db(db_files_list):
    ...
    merged_json_data["tuning_problem_name"] = "rsbench"
...
db_files_list =[]
db_files_list.append("TLA_experiments/SLA-GPTune-s-200/rsbench.json")
db_files_list.append("TLA_experiments/SLA-GPTune-m-200/rsbench.json")
db_files_list.append("TLA_experiments/SLA-GPTune-l-200/rsbench.json")
...
# db_files_list.append("TLA_experiments/SLA-GPTune-l-5/xsbench.json")
