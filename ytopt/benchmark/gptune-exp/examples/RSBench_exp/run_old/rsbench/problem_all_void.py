...
obj = Plopper(dir_path+'/mmp_void.c',dir_path)
...
def myobj(point: dict):
  ...
  def plopper_func(x):
    ...
    result = obj.findRuntime(value, params, ' -s large') # defined(MINI_DATASET) && !defined(SMALL_DATASET) && !defined(MEDIUM_DATASET) && !defined(LARGE_DATASET) && !defined(EXTRALARGE_DATASET) && !defined(HUGE_DATASET)
    return result
