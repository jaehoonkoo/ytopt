...
spack load gptune 
### go the directory 
cd /gpfs/jlse-fs0/users/jkoo/code/gptune/examples/RSBench_exp/rsbench_gptune_tla1
# mpirun -n 1 python demo_tla1.py -nrun 200 -ntask 3 -perfmodel 0 -optimization GPTune -tla 1

################################ RUN SLA for small 
# cd /gpfs/jlse-fs0/users/jkoo/code/gptune/examples/RSBench_exp/rsbench_gptune_tla1
rm -rf gptune.db
python demo_tla1.py -nrun 200 -ntask 3 -perfmodel 0 -optimization GPTune -tla 1 
mv gptune.db/rsbench.json ./TLA_experiments/SLA-GPTune-mla-200/
mv save_results.npy save_results_mla_tla1_rsbench.npy
