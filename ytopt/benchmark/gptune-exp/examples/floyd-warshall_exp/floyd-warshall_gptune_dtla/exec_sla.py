...
input_sizes= {}
input_sizes[(180)]  = [' -DSMALL_DATASET'] 
input_sizes[(340)] = [' -DSM_DATASET'] 
input_sizes[(500)]  = [' -DMEDIUM_DATASET'] 
input_sizes[(1650)] = [' -DML_DATASET'] 
input_sizes[(2800)]  = [' -DLARGE_DATASET'] 
input_sizes[(5600)] = [' -DEXTRALARGE_DATASET'] 
################################### 
...
def create_gptune(Kernel_name, nodes, cores, n_param, param_start, param_name, i_min, i_max, task_name):
    ...
    tuning_metadata = {
        ...
        "use_crowd_repo": "no",
        "machine_configuration": {"machine_name": "swing","amd": { "nodes": nodes, "cores": cores }},
        "software_configuration": {},
        "loadable_machine_configurations": {"swing": {"amd": {"nodes": nodes,"cores": cores}}},
    ...
    Tuning_params = [p1,p2,p3,p4,p5,p6,p7,p8]
#     r = Real(float("-Inf"), float("Inf"), name="y")
    ...
    historydb = None#HistoryDB(meta_dict=tuning_metadata)
