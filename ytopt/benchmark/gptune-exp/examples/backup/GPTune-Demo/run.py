...
rm -rf gptune.db
rm -rf a.out.log
mpirun -n 1 python ./demo.py -ntask 1 -nrun 10 -tvalue 0.6 -optimization GPTune | tee a.out.log
mv gptune.db/GPTune-Demo.json TLA_experiments/SLA-GPTune-0.6-10/GPTune-Demo.json
mv a.out.log TLA_experiments/SLA-GPTune-0.6-10/a.out.log
rm -rf gptune.db
rm -rf a.out.log
mpirun -n 1 python ./demo.py -ntask 1 -nrun 20 -tvalue 0.6 -optimization GPTune | tee a.out.log
mv gptune.db/GPTune-Demo.json TLA_experiments/SLA-GPTune-0.6-20/GPTune-Demo.json
mv a.out.log TLA_experiments/SLA-GPTune-0.6-20/a.out.log
rm -rf gptune.db
rm -rf a.out.log
...
run_cmd = '/Users/jkoo/research/github/GPTune/openmpi-4.0.1/bin/mpirun -n 1 python ./demo.py -ntask 1 -nrun 50 -tvalue 0.6 -optimization GPTune | tee a.out.log'
# run_command = ['/Users/jkoo/research/github/GPTune/openmpi-4.0.1/bin/mpirun -n 1 python ./demo.py -ntask 1 -nrun 40' '-tvalue' '0.6' '-optimization' 'GPTune' '| tee' 'a.out.log']
# run_command =["ls", "-l"] #subprocess.run(["ls", "-l", "/dev/null"], capture_output=True)
print (run_cmd)
subprocess.run(run_cmd, shell=True, stdout=subprocess.PIPE)
