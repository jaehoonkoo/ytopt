...
# input_sizes['xxl'] = [int(1000000000)]

input_sizes['s']  = [500000000]
input_sizes['sm'] = [750000000]
input_sizes['m']  = [1000000000]
input_sizes['ml'] = [1250000000]
input_sizes['l']  = [1500000000]
# input_sizes['l']  = [1700000000]
input_sizes['xl']  = [2000000000]
...
def objectives(point: dict):
  ...
  def plopper_func(x):
    ...
    result, cmd, counter = obj.findRuntime(value, params, ' -m event -l '+ d_size) # 
...
#     p0 = Integer(1, 8, transform="normalize", name="p0")
    ...
    p6 = Categoricalnorm(['dynamic','static'], transform="onehot", name="p6") 
    
    r = Real(float(0.0), float("Inf"), name="y")

    IS = Space([t])
    PS = Space([p0, p1, p2, p3, p4, p5, p6])
    OS = Space([r])    

#     output_space = Space([Real(float(0.0), float('Inf'), name="y")])
