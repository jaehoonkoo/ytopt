...
class Plopper:
    ...
    def findRuntime(self, x, params, flags):
        interimfile = ""
        #exetime = float('inf')
        #exetime = sys.maxsize
        exetime = 1
...
#         cmd1 = "nvcc -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda -Xopenmp-target -O3 "  + \
# 		" -o " + tmpbinary + " " + interimfile +" " + kernel_dir + "/Materials.c " \
#                 + kernel_dir + "/XSutils.c " + " -I" + kernel_dir + \
#                 " -lm"
        cmd1 = "nvc -mp=gpu -Wall -fopenmp -O3 "  + \
		" -o " + tmpbinary + " " + interimfile +" " + kernel_dir + "/Materials.c " \
                + kernel_dir + "/XSutils.c " + " -I" + kernel_dir + \
                " -lm"
        print (cmd1)
#         cmd2 = kernel_dir + "/exe.pl " +  tmpbinary
#         cmd2 = 'srun -n 1 ' + tmpbinary + str(flags)
        cmd2 = tmpbinary + str(flags)
        print (cmd2)
...
#             print (cmd2)
            ...
            print ('........................................',exetime_run)
            exetime = exetime_run
            cmd3 = "mv " + kernel_dir + "/"+str(counter) + ".o " + kernel_dir + "/tmp_files/"
            execution_status = subprocess.run(cmd3, shell=True, stdout=subprocess.PIPE)
            if exetime == 0:
                exetime = 1
        else:
