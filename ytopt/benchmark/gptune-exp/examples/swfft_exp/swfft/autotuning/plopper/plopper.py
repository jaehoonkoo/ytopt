...
class Plopper:
    ...
    def findRuntime(self, x, params):
        ...
        cmd1 = "cc -g -O2 -fopenmp -Wall -Wno-deprecated -std=gnu99 -DDFFT_TIMING=0 -I/opt/cray/pe/fftw/3.3.8.6/mic_knl/include -c -o " \
                +kernel_dir + "/distribution.o " + kernel_dir + "/distribution.c " \
                + "| CC -g -O2 -fopenmp -Wall -DDFFT_TIMING=0 "  + \
		" -o " + tmpbinary + " " + interimfile +" " + kernel_dir + "/distribution.o " \
                + " -I" + kernel_dir + \
                " -I/opt/cray/pe/fftw/3.3.8.6/mic_knl/include -L/opt/cray/pe/fftw/3.3.8.6/mic_knl/lib -lfftw3_omp -lfftw3 -lm "
