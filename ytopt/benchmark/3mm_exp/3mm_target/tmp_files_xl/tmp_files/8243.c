...
#pragma clang loop(i,j,k) tile sizes(100,2048,4) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
...
#pragma clang loop(i3,j3,k3) tile sizes(100,2048,4) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
...
#pragma clang loop(i4,j4,k4) tile sizes(100,2048,4) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
