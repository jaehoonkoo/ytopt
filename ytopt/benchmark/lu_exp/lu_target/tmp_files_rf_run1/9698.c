...
#pragma clang loop(i,j,k) tile sizes(4,16,80) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
...
#pragma clang loop(i1,j1,k1,i2,j2) interchange permutation(j1,k1,i1,j2,i2)
#pragma clang loop(i3,j3,k3) tile sizes(4,16,80) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
