...
# mv results_sdv.csv results_sdv_sm_lu.csv
# # ##############
python Run_online_TL.py --kernel_name lu --max_evals 30 --n_refit 30 --top 0.3 --nparam 5 --param_start 1 --target ml -itarget 1200 -imin 40 -imax 6000
mv tmp_files tmp_files_ml
mv results_sdv.csv results_sdv_ml_lu.csv
# # ##############
# python Run_online_TL.py --kernel_name lu --max_evals 30 --n_refit 30 --top 0.3 --nparam 5 --param_start 1 --target xl -itarget 4000 -imin 40 -imax 6000
# mv tmp_files tmp_files_xl
# mv results_sdv.csv results_sdv_xl_lu.csv
# ##############
# python Run_online_TL.py --kernel_name lu --max_evals 30 --n_refit 30 --top 0.3 --nparam 5 --param_start 1 --target sm -itarget 260 -imin 40 -imax 6000
