...
dataframe = pd.read_csv("results_rf_l_heat-3d.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:6]   
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rf_l_heat-3d_rerun.csv"
...
dataframe = pd.read_csv("results_rs_l_heat-3d.csv") # PROBLEM_SIZE	BLOCK_SIZE	exe_time	LOG(exe_time)	speedup	elapsed_sec
array = dataframe.values
X_evals_re = array[:,:6]   
N_infer = len(X_evals_re)
# name of csv file 
filename = "results_rs_l_heat-3d_rerun.csv"
fields   = ['p0','p1','p2','p3','p4','p5','exe_time1','exe_time2','exe_time3']
# writing to csv file 
with open(filename, 'w') as csvfile: 
    # creating a csv writer object 
