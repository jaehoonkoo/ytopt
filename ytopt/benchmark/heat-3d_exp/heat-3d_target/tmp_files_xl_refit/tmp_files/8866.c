...
#pragma clang loop(i,j,k) tile sizes(100,32,64) floor_ids(i1,j1,k1) tile_ids(i2,j2,k2)
...
#pragma clang loop(l,m,p) tile sizes(100,32,64) floor_ids(l1,m1,p1) tile_ids(l2,m2,p2)
